<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cau3.aspx.cs" Inherits="Câu_1.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table class="auto-style3">
            ...
            <tr>
                <td class="auto-style5" colspan="3">Kết quả:&nbsp; <asp:TextBox ID="txtKetQua" runat="server" Height="22px" Width="197px"></asp:TextBox>
                </td>
            </tr>
        </table>
    </form>
